...
Необходимо найти компании, которые выпустили фильмы снятые режиссёрами, снимавшими более 3 фильмов, и средний бюджет
этих фильмов превышает 5 миллионов. В результатах выводим название компании и средний бюджет.
