...
Подсчитайте общее количество рейсов и среднюю длительность полетов для каждой авиакомпании, в результаты должны попасть
только те рейсы средняя продолжительность которых больше 3. Необходимо вывести название авиакомпании, общее число
рейсов, среднюю продолжительность полета. Группировка будет по названию авиакомпании
*/
