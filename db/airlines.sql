...
операторов. Синтаксис имеет следующий вид:
 ...
 Необходимо определить авиакомпании, у которых с '2023-01-05' по '2023-01-10' будет выполнено более одного рейса.
 Необходимо вывести название авиакомпании и количество рейсов. Группировка будет по названию авиакомпании.
*/
